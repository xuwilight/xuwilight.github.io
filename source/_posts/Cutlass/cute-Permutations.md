...
第二个参数是 MMAThrLayout，代表将 MMA_OP 的线程按照什么 layout 进行复制。如果使用 SM80 的 mma，一个 mma 指令有 32 个线程，MMAThrLayout = <2,2,1> 的话就是在 M 和 N 方向上各复制一份 mma，这样一共就有 128 个线程了。
...
![](/assets/Permutations/image1.png)
...
![](/assets/Permutations/image2.png)
...
此时打印结果如下。可以看到线程以 16×8 为单元，按照预期的 layout 排列。后面只需要修改 Permutations 把数据变得连续就好了。

![](/assets/Permutations/image3.png)
...
![](/assets/Permutations/image4.png)
